...
<div class="container-fluid mt-4 mb-5 px-4">
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3">
        ...
        <div class="d-flex gap-2 flex-wrap">
            <button class="btn btn-dark btn-modern" data-bs-toggle="modal" data-bs-target="#modalUsuarios">
                <i class="bi bi-people me-2"></i>Usuarios
            </button>
            <a href="exportar_excel.php" class="btn btn-success btn-modern">
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody id="filasInventario">
                    ...
                    <tr>
                        ...
                        <td><span class="badge bg-light text-dark border-0 px-2 py-1"><?php echo $p['tipo']; ?></span></td>
                        ...
                        <td class="text-center">
                            <div class="btn-group shadow-sm" style="border-radius: 8px; overflow: hidden;">
                                <button class="btn btn-white btn-sm border-end" onclick='prepararEdicion(<?php echo json_encode($p); ?>)' title="Editar">
                                    <i class="bi bi-pencil-fill text-secondary"></i>
                                </button>
                                <button class="btn btn-white btn-sm border-end" onclick="prepararMovimiento(<?php echo $p['id']; ?>, '<?php echo addslashes($p['nombre']); ?>')" title="Movimiento">
                                    <i class="bi bi-arrow-left-right text-primary"></i>
                                </button>
                                <button class="btn btn-white btn-sm" onclick="eliminarProducto(<?php echo $p['id']; ?>, '<?php echo addslashes($p['nombre']); ?>')" title="Eliminar">
...
<div class="modal fade" id="modalNuevo" tabindex="-1" aria-hidden="true">
    ...
    <form id="formNuevoMaterial" class="modal-content border-0 shadow-lg" style="border-radius: 15px;">
        ...
        <div class="modal-body p-4">
            <h6 class="text-secondary fw-bold text-uppercase mb-3 pb-2 border-bottom" style="font-size: 0.8rem; letter-spacing: 1px;">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-4">
                    ...
                    <input type="text" name="codigo_interno" class="form-control" placeholder="Ej: ART-001" required>
                </div>
                <div class="col-md-8">
                    <label class="form-label small fw-bold text-secondary">DESCRIPCIÓN / NOMBRE</label>
                    <input type="text" name="nombre" class="form-control" placeholder="Nombre completo del material" required>
                </div>
            </div>
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input list="datalistFabricantes" name="fabricante" class="form-control border-start-0" placeholder="Buscar o crear...">
                    </div>
                </div>
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input list="datalistCategorias" name="tipo" class="form-control border-start-0" placeholder="Buscar o crear..." required>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="almacen" class="form-control border-start-0" placeholder="Ubicación (Ej: Torre A, Almacén Central)">
                    </div>
                </div>
                <div class="col-md-3">
                    <label class="form-label small fw-bold text-secondary">STOCK INICIAL</label>
                    <input type="number" step="0.01" name="stock_actual" class="form-control text-primary fw-bold" value="0">
                </div>
                <div class="col-md-3">
                    <label class="form-label small fw-bold text-secondary">STOCK MÍNIMO</label>
                    <input type="number" step="0.01" name="stock_minimo" class="form-control text-danger fw-bold" value="0">
                </div>
            </div>
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" step="0.01" name="precio_unitario" class="form-control border-start-0 fw-bold" placeholder="0.00">
                    </div>
                </div>
                <div class="col-md-8">
                    <label class="form-label small fw-bold text-secondary">OBSERVACIONES</label>
                    <textarea name="observaciones" class="form-control" rows="2" placeholder="Notas internas adicionales..."></textarea>
                </div>
            </div>
        </div>

        <div class="modal-footer border-0 bg-light p-3" style="border-bottom-left-radius: 15px; border-bottom-right-radius: 15px;">
            <button type="button" class="btn btn-outline-secondary border-0 fw-bold" data-bs-dismiss="modal">CANCELAR</button>
...
<div class="modal fade" id="modalEditar" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <form id="formEditar" class="modal-content border-0 shadow-lg" style="border-radius: 15px;">
            <div class="modal-header bg-secondary text-white border-0 py-3" style="border-top-left-radius: 15px; border-top-right-radius: 15px;">
            ...
            <div class="modal-body p-4">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.01" name="stock_minimo" id="edit_stock_minimo" class="form-control border-danger-subtle text-danger fw-bold">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label small fw-bold text-secondary">PRECIO (S/)</label>
                        <input type="number" step="0.01" name="precio_unitario" id="edit_precio" class="form-control border-primary-subtle text-primary fw-bold">
                    </div>
                </div>
            </div>
            <div class="modal-footer border-0 bg-light p-3" style="border-bottom-left-radius: 15px; border-bottom-right-radius: 15px;">
...
<div class="modal fade" id="modalUsuarios" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 15px;">
            <div class="modal-header bg-dark text-white border-0 py-3" style="border-top-left-radius: 15px; border-top-right-radius: 15px;">
                        ...
                        <form id="formUsuario">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="usuario" id="user_name" class="form-control border-start-0" placeholder="Ej: dportella" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" name="password" id="user_pass" class="form-control border-start-0" placeholder="••••••••">
                                </div>
...
<div class="mb-4">
    ...
    <div class="form-control bg-light fw-bold text-primary border-0 shadow-sm d-flex align-items-center" style="height: 38px;">
        ADMINISTRADOR
    </div>
    <input type="hidden" name="rol" id="user_rol" value="admin">
</div>

                            <button type="submit" id="btnGuardarUser" class="btn btn-primary w-100 fw-bold shadow-sm py-2">
                                <i class="bi bi-save me-2"></i>GUARDAR USUARIO
                            </button>
                            <button type="button" id="btnCancelarEdicion" class="btn btn-link w-100 text-decoration-none mt-2 text-danger small fw-bold" style="display:none;">
                                CANCELAR EDICIÓN
                            </button>
                        </form>
                    </div>
                    ...
                    <div class="col-md-8 ps-4">
                        <h6 class="fw-bold mb-3 text-secondary text-uppercase small" style="letter-spacing: 1px;">Usuarios en el Sistema</h6>
                        <div class="table-responsive">
                                    ...
                                    foreach ($all_users as $u): ?>
                                        <tr id="user_row_<?php echo $u['id']; ?>">
                                            <td class="fw-bold text-dark">
                                                <i class="bi bi-person-circle me-2 text-primary"></i><?php echo $u['usuario']; ?>
                                            </td>
                                            <td><span class="badge bg-primary-subtle text-primary border border-primary-subtle rounded-pill px-3"><?php echo $u['rol']; ?></span></td>
                                            <td class="text-end">
